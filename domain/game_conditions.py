...
#     def __init__(self, location, items, all_items, not_items, text, new_location, new_items, new_not_items):
...
#         self.new_not_items = new_not_items
...
game_conditions = [
    ...
    StateCondition("corridor->kitchen", "Зайти на кухню", "Коридор", {}, {"corridorLight"}, {},
                   "Кухня", {}, {}, "Кухня! Можно и перекусить 🤤")
]
